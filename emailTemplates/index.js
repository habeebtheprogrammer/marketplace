...
`
  ...
  <body style="margin:0; padding:0; background-color:#f8f9fa; font-family:-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
    ...
    <div style="display:none; max-height:0; overflow:hidden; mso-hide:all; font-size:1px; line-height:1px; color:#f8f9fa; opacity:0;">
      Use this code to complete your verification securely — it will expire soon.
    </div>
      ...
      <tr>
        <td align="center" style="padding:40px 20px;">
          <table role="presentation" class="container" width="600" cellspacing="0" cellpadding="0" style="max-width:600px; background-color:#ffffff; border-radius:8px; box-shadow:0 2px 8px rgba(0,0,0,0.1);">
            ...
            <!-- Message -->
            <tr>
              <td class="mobile-padding" style="padding:30px 40px 0 40px; text-align:center;">
                <h2 style="margin:0; font-size:20px; font-weight:600; color:#292929;">
                  Your One-Time Verification Code
                </h2>
                <p style="margin:16px 0 0; font-size:15px; color:#555;">
                  Use the code below to verify your sign-in. This code will expire shortly for security reasons.
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:25px 40px 10px; text-align:center;">
                <div style="display:inline-block; font-size:28px; letter-spacing:10px; font-weight:700; color:#000;">
                  ${code}
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:10px 40px 30px; text-align:center;">
                <a href="https://360gadgetsafrica.com" 
                   style="background-color:#000; color:#fff; text-decoration:none; padding:12px 28px; font-size:15px; font-weight:600; border-radius:6px; display:inline-block;">
                  Continue
                </a>
              </td>
            </tr>
            ...
            <tr>
              <td class="mobile-padding" style="padding: 30px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #ffd93d; border-radius: 6px;">
                  <tr>
                    <td style="padding: 20px; text-align: center;">
                      <p style="margin: 0; font-size: 12px; color: #e91e63; font-weight: bold; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px;">
                        Need Help?
                      </p>
                      <h2 style="margin: 0; font-size: 16px; font-weight: 600; color: #292929;">
                        Reply to this email — our team is always ready to assist you.
                      </h2>
                    </td>
                  </tr>
                </table>
