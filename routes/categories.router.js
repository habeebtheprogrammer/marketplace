...
const { checkAuth, vendorsAccessOnly, adminOrVendorAccessOnly } = require('../utils/authMiddleware');
const { categoryCreationValidator, updateValidator } = require('../utils/validator');
var router = express.Router();

router.get('/', categoriesController.getCategories);
router.post('/', checkAuth, adminOrVendorAccessOnly, categoryCreationValidator, categoriesController.createCategories);
